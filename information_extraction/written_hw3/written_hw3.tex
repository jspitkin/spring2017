...
\fbox{ \parbox{0.70\linewidth}{
VICTIM = "Several people" and "The injured people"\\
LOCATION = "central Huntsville"
} }
...
\textbf{MUC recall:} $\mathbf{3 / 9 = 0.3333}$
} }
\newline 
...
\fbox{ \parbox{0.35\linewidth}{
\textbf{MUC precision:} $\mathbf{3 / 8 = 0.375}$
} }
...
\textbf{$B^3$ recall:} $\mathbf{6.3 / 14 = 0.45}$
} }
...
\fbox{ \parbox{0.32\linewidth}{
\textbf{$B^3$ precision:} $\mathbf{25 / 42 = 0.595}$
} }
