...
\begin{tikzpicture}[->,>=stealth',shorten >=1pt,auto,node distance=2.8cm,
  ...
  \node[draw, circle]         (C) [below right of=B] {$f$};
...
$$y_1 = max \{ 0, 2x - 1 \} \qquad y_2 = max \{ 0, -2x + 1 \} \qquad f = max \{0, - y_1 - y_2 + 1 \}$$

As a function of $x$ this is defined as 
...
\fbox{ \parbox{1\linewidth}{
Taking the network from part a, we can stack the network on top of itself
